...
pub async fn create_incoming_steel_routes() -> Router {
    ...
    .route("/:user/:login_key/upload_incoming_steel_csv", post(CreateIncomingSteelRequest::upload_incoming_steel_csv))
    ...
    .route("/:user/:login_key/get_heat_nos_list", get(FindIncomingSteelRequest::get_heat_nos_list))
