...
pub async fn create_bill_of_material_routes() -> Router {
    ...
    .route("/:user/:login_key/find_all_dwg_no", get(FindBillOfMaterialRequest::find_all_dwg_no))
    .route("/:user/:login_key/find_by_dwg_no", get(FindBillOfMaterialRequest::find_by_dwg_no))
